...
import FiliterResultScreen from "../screens/FiliterResultScreen";
...
const HomeNav = () => (
  <Stack.Navigator>
    ...
    <Stack.Screen name="DogSearch" component={DogSearchScreen} />
    <Stack.Screen name="DogDetail" component={DogDetailScreen} />
    <Stack.Screen name="CatSearch" component={CatSearchScreen} />
    <Stack.Screen name="CatDetail" component={CatDetailScreen} />
    <Stack.Screen name="AdoptDetail" component={AvailableAdopt} />
  </Stack.Navigator>
);

const AdoptPetNav = () => (
  <Stack.Navigator>
    <Stack.Screen name="AdoptPet 🦮" component={AdoptPetScreen} />
    <Stack.Screen name="AdoptPetDetail" component={AdoptPetDetailScreen} />
    <Stack.Screen name="NewAdopt" component={NewAdoptPetScreen} />
  </Stack.Navigator>
);
...
const AdoptFormScreenPetNav = () => (
  <Stack.Navigator>
    ...
    <Stack.Screen name="FiliterResultScreen" component={FiliterResultScreen} />
  </Stack.Navigator>
);
    ...
    <NavigationContainer>
      <Drawer.Navigator>
        ...
        <Drawer.Screen
          ...
          component={AdoptFormScreenPetNav}
        />
