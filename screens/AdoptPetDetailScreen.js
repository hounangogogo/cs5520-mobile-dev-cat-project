...
class AdoptPetDetailScreen extends Component {
  ...
  getAnimalFromDB = () => {
    ...
    let tmpAnimal = this.props.adoptAnimalFromDB.find(
      (ani) => ani.id === this.state.animalId
    );
        ...
        {isFromApi
              ...
              <View>
                ...
                <View style={styles.outsideContainer}>
                  <Text style={styles.headText}>
                    More about this cute {apiAnimal.species}!{" "}
                  </Text>
                  ...
                  <View style={styles.tableContainer}>
                    <Grid style={{ borderRadius: 100 }}>
                      ...
                      >
                        ...
                        <Col>
                          <Text style={styles.tableText}>
                            {apiAnimal.contact["address"]["city"]},{" "}
                            {apiAnimal.contact["address"]["state"]}
                          </Text>
                        </Col>
                      </Row>
                    </Grid>
          ...
          : dbAnimal && (
              <View>
                ...
                <View style={styles.outsideContainer}>
                  <Text style={styles.headText}>
                    More about this cute {dbAnimal.species}!{" "}
                  </Text>
